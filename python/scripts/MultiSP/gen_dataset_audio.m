...
csvwrite('.\\ds\\dataset_audio_lips_128ch_in_600_train.csv',datasetin(:,1:600)',0,0);
csvwrite('.\\ds\\dataset_audio_lips_128ch_out_600_train.csv',datasetout(:,1:600)',0,0);
csvwrite('.\\ds\\dataset_audio_lips_128ch_in_51_val.csv',datasetin(:,601:end)',0,0);
csvwrite('.\\ds\\dataset_audio_lips_128ch_out_51_val.csv',datasetout(:,601:end)',0,0);
